        ...
        if (data.IsRegistered)
        {
            ...
            if (data.Registration.Chart != null)
            {
                ...
                if (FXLab.UseNativeRenderTextures)
                    EditorGUI.DrawPreviewTexture(texArea, data.Registration.Chart.Data.RenderTexture, data.IsFloatTexture ? displayFloatTextureMaterial : displayTextureMaterial);
                else
