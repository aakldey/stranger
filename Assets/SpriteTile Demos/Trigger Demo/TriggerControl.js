...
function Awake () {
	...
	for (tObj in textObjects) {
		...
		tObj.renderer.sortingOrder = 1;	// Makes text draw above tiles (0) but below the player sprite (2)
	}
	textObjects[0].position = Tile.GetWorldPosition (Int2(2, 17));
	textObjects[1].position = Tile.GetWorldPosition (Int2(3, 5));
	textObjects[2].position = Tile.GetWorldPosition (Int2(3, 2));
	textObjects[3].position = Tile.GetWorldPosition (Int2(19, 14));
	textObjects[4].position = Tile.GetWorldPosition (Int2(19, 5));
}
