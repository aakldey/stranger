...
public class TileEditorWindow : EditorWindow {
	...
	void OnGUI () {
		...
		EditorGUILayout.BeginVertical();
			...
			this.BoxCollider2D = EditorGUILayout.Toggle("Box collider", this.BoxCollider2D);
	...
	public void Setup(TileLayerEditor editor, TileInstance[] selectedTiles) {
		...
		if(layer.tileset!=null) {
			...
			if(tile!=null) {
				...
				this.BoxCollider2D = tile.BoxCollider2D;
	...
	public void Save() {
		...
		foreach(TileInstance selectedTile in this.selectedTiles)
		{
			...
			tile.BoxCollider2D = this.BoxCollider2D;
