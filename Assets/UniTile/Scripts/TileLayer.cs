...
{	
	...
	/// </summary>
	public UniTileTemplate selection = new UniTileTemplate();
	...
	[HideInInspector] public string replacerGUID = "";
	[HideInInspector] public UniTileResizeMode resizeMode;
#endif
